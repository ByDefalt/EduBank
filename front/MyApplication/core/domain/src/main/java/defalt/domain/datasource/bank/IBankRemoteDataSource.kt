package defalt.domain.datasource.bank
...
interface IBankRemoteDataSource {

    // --- ADMIN : Comptes bancaires (BankAccountApi) ---
    ...
    /** [ADMIN] Ajoute un co-titulaire à un compte (crée un lien pivot) */
    ...
    /** [CLIENT] Récupère tous les liens pivots associés à l'ID utilisateur (ses propres comptes et co-titularités) */
