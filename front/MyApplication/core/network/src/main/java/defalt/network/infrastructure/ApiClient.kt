...
import defalt.network.infrastructure.Serializer.kotlinxSerializationJson
import okhttp3.Call
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey: String = "com.example.api.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "http://localhost:8081/api/v1")
        }
    }
}
