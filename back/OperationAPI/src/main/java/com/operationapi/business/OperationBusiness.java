...
public class OperationBusiness {
    ...
    public Operation save(Operation operation) {
        ...
        operation.setState(Operation.StateEnum.PENDING);
    ...
    public Operation updateStateOperation(Integer id, Operation.StateEnum state) {
        ...
        if (Operation.StateEnum.CANCELLED.equals(existing.getState())) {
    ...
    public Map<String, Operation> cancelOperation(Integer id) {
        ...
        if (Operation.StateEnum.CANCELLED.equals(original.getState())) {
            throw new FunctionalException("400", "L'opération est déjà annulée");
        }

        this.operationRepository.updateState(id, Operation.StateEnum.CANCELLED);
        ...
        cancellation.setState(Operation.StateEnum.COMPLETED);
